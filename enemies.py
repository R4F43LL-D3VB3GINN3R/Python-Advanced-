...
#------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
    ...
    def __init__(self, pos):  # Este é o método construtor da classe Enemies, que é chamado automaticamente quando uma nova instância (objeto) da classe é criada. 
        ...
        self.scale_factor = 1.8                                 # Tamanho do sprite. 
...
#------------------------------------------------------#
        ...
        self.skullmovel = 25                        # Recebe a distância que percorre na direcão esquerda.                       
        self.skullmover = 25                        # Recebe a distância que percorre na direcão direita.                                 
...
#------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
    ...
    def jump(self): # Este método aplica a forca do salto no vetor y. 
        ...
        if self.on_ground:                      # Verifica se o inimigo está no chão.
            self.direction.y = self.jump_speed  # A direcao do Vetor y recebe o valor negativo do salto, impulsionando-o para cima.
...
#------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
    ...
    def move(self): # Método para definir os movimentos dos inimigos.
        ...
        if self.skullmovel > 0:                                             # Se a variável for maior que zero...
            self.skullmovel -= 1                                            # Decrementa 1 da variável iniciada como 25.
            ...
            self.skullmover -= 1                                            # Decrementa 1 da vriável iniciada como 25.
        ...
        if self.skullmovel == 0 and self.skullmover == 0:                   # Se as duas variáveis forem decrementadas até 0...
            self.skullmovel = 25                                            # Elas recebem o valor original para que o código funcione como um ciclo. 
            self.skullmover = 25 
